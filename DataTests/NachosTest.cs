...
{
    /// <summary>
    /// class for testing the Nacho class
    /// </summary>
    public  class NachosTest
    {
        /// <summary>
        ...
        /// <summary>
        ///nachos implements INotifyPropertyChanged interface
        /// </summary>
        [Fact]
        public void NachosShouldImplementINotifyPropertyChanged()
        ...
        /// <summary>
        /// nachos object can  be cast to IMenuItem and base classes
        /// </summary>
        ...
        {
            Nachos nacho = new();
            Assert.IsAssignableFrom<Entree>(nacho);
            Assert.IsAssignableFrom<IMenuItem>(nacho);
        }
        /// <summary>
        ...
        [Theory]
        [InlineData(Salsa.None, true, true, true, true, true, true, true, true, true, 2 * 130 + 110 + 20 + 100 + 2 * 150 + 180 + 210 + 250)]
        [InlineData(Salsa.Hot, false, false, false, false, false, false, false, false, false, 250 + 20)]
        [InlineData(Salsa.Medium, true, false, true, true, false, false, false, true, true, 130 + 110 + 20 + 210 + 180 + 20 + 250)]
        [InlineData(Salsa.Mild, false, false, false, false, true, true, true, true, true, 150 + 100 + 210 + 180 + 150 + 20 + 250)]
        [InlineData(Salsa.Green, true, true, true, true, true, true, false, false, false, 2 * 130 + 110 + 20 + 100 + 150 + 20 + 250)]
        ...
        /// </summary>
        [Fact]
        public void BaseSetToChips()
        {
            Nachos bowl = new();
            Assert.Equal(Ingredient.Chips.ToString(), bowl.Base.IngredientType.ToString());
        }
        /// <summary>
